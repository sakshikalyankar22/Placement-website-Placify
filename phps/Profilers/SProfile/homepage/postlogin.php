...
<body>
    ...
    <!-- offcanvas start -->
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasRightWithBothOptions" aria-labelledby="offcanvasRightWithBothOptionsLabel" style="background-color: rgba(181, 209, 227, 0.7);">
        ...
        <div class="offcanvas-body">
            ...
            <!-- collapse start -->
            <div class="flex-shrink-0 p-3 bg-white" style="width: 280px; background-color: rgba(181, 209, 227, 0.7);">
                ...
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="account-collapse" style="width: 280px;">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="../ForgotPassword.php" class="link-dark rounded">
                                        <h5>Change Password</h5>
                                    </a></li>
                                <li><a href="../logout.php" class="fa fa-eject fa-fw">
                                        <h5>logout</h5>
                                    </a></li>
            ...
            <div class="row">
                <div class="col-6 col-md-2 mb-3 text-white">
                    ...
                    <ul class="nav flex-column text-white">
                        ...
                        <li class="nav-item mb-2"><a href="../sloginform.php" class="nav-link p-0 text-white">Student login</a></li>
