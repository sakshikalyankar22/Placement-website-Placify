        ...
        <div class="mx-2">
          <div class="btn-group">
            ...
            <ul class="dropdown-menu bg-dark">
              ...
              <li><a class="dropdown-item text-white" href="../login/sloginform.php">Student</a></li>
              <!-- <li><a class="dropdown-item text-white" href="#">HOD</a></li> -->
              <li><a class="dropdown-item text-white" href="../login/aloginform.php">Administrative</a></li>
            </ul>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <a href="../login/register.php"><b>
              <h5>Student</h5>
            </b></a><br>
          
          <a class="dropdown-item text-red" href="../login/register.php"><b>
