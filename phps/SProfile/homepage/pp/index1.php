...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh;
            overflow-y: scroll;
            /* Add scrollbar to the whole page */
        }
...
<body>
    ...
    <div class="company-section">
        <div class="company-card" data-category="Internet Services">
            ...
            <a class="company-name" href="../jw/form3.php">Google</a>
            <!-- <div class="company-name" href="../jw/form.php">Google</div> -->
        ...
        <div class="company-card" data-category="E-commerce">
            ...
            <a class="company-name" href="../jw/form2.php">Amazon</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="E-commerce">
            ...
            <a class="company-name" href="../jw/form1.php">Flipkart</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Technology">
            ...
            <a class="company-name" href="../jw/form.php">Adobe</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Electronics">
            ...
            <a class="company-name" href="../jw/form.php">Apple</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Entertainment">
            ...
            <a class="company-name" href="../jw/form.php">Netflix</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Technology">
            ...
            <a class="company-name" href="../jw/form.php">Microsoft</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Internet Services">
            ...
            <a class="company-name" href="../jw/form.php">Facebook</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Technology">
            ...
            <a class="company-name" href="../jw/form.php">Oracle</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Electronics">
            ...
            <a class="company-name" href="../jw/form.php">Samsung</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Consulting Services">
            ...
            <a class="company-name" href="../jw/form.php">Cognizant</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Consulting Services">
            ...
            <a class="company-name" href="../jw/form.php">Hexaware</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Consulting Services">
            <img class="company-logo" src="ama.jpeg" alt="Amazon Logo">
            <a class="company-name" href="../jw/form.php">TCS</a>
            <div class="company-details">
        ...
        <div class="company-card" data-category="Entertainment">
            <img class="company-logo" src="./sony.jpg" alt="sony Logo">
            <a class="company-name" href="../jw/form.php">Sony</a>
            <div class="company-details">
                <p>Samsung is a global electronics company.</p>
                <p>Highlights:</p>
                <ul>
