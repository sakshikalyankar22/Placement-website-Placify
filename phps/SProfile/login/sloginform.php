...
<body class="light-gray-bg">
	<div class="templatemo-content-widget templatemo-login-widget white-bg">
		...
		<form action="login2.php" class="templatemo-login-form" method="POST">
			...
			<div class="row">
				<div class="col-6 col-md-2 mb-3 text-white">
					...
					<ul class="nav flex-column text-white">
						...
						<li class="nav-item mb-2"><a href="" class="nav-link p-0 text-white">Student login</a></li>
						<li class="nav-item mb-2"><a href="aloginform.php" class="nav-link p-0 text-white">Administrative login</a></li>
				...
				<div class="col-6 col-md-2 mb-3 text-white">
					<h5>HELP</h5>
					<ul class="nav flex-column text-white">
						<li class="nav-item mb-2"><a href="../homepage/Placify/alumni.php" class="nav-link p-0 text-white">Alumini Support</a></li>
