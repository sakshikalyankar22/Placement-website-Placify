        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href = "../homepage/pp/index.php" >Companies</a>
                ...
                <div class="mx-2">
                    <div class="btn-group">
                        <a class="btn btn-outline-secondary dropdown-toggle text-white" type="button"
                            data-bs-toggle="dropdown" aria-hashpop="true" aria-expanded="false">
                            Login
                        </a>
                    ...
                    <button class="btn btn-outline-secondary text-white" data-bs-toggle="modal"
