                    ...
                    <nav class="navbar bg-body-tertiary">
                     <div class="container-fluid">
                      <a class="navbar-brand" href="#">
                        <!-- <img src="images/bird_2.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top"> -->
                        PLACIFY
                      </a>
                    </div>
                    </nav>                
  ...
  <div class="container-fluid mx-auto">                  
    ...
    <form class="d-flex" role="search">
      ...
      <button class="btn btn-outline-success" type="submit">Search</button>
                    ...
                    <!-- <a class="navbar-brand page-scroll" href="https://www.sggs.ac.in/">SHRI GURU GOBIND SINGHJI INSTITUTE OF ENGINEERING AND TECHNOLOGY</a> -->
                ...
                <!-- Optional: Add a logo or site title -->
                ...
                <div class="nav navbar-nav navbar-right">
                 <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <!-- Add a link to the OpenAI website
                        <li><a href="https://www.openai.com" target="_blank">OpenAI Website</a></li>
                    </ul>
                 </div>
                </div>
                    </ul>
        ...
        <div class="footer" style="background:orange">
			<div class="container">
