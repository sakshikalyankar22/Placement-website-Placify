      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="../Profilers/SProfile/index.php">Student</a>
      ...
      <!-- <div class="mx-2"> -->
        ...
        <div class="btn-group">
          <a class="btn btn-outline-secondary dropdown-toggle text-white" type="button" data-bs-toggle="dropdown"  aria-hashpop="true" aria-expanded="false">
           ...
           <ul class="dropdown-menu bg-dark">
             <li><a class="dropdown-item text-white" data-bs-toggle="modal" data-bs-target="#loginModal" href="../Profilers/SProfile/index.php">Student</a></li>
        ...
        <div class="btn-group">
          <a class="btn btn-outline-secondary dropdown-toggle text-white" type="button" data-bs-toggle="dropdown"  aria-hashpop="true" aria-expanded="false">
           ...
           <ul class="dropdown-menu bg-dark">
             <li><a class="dropdown-item text-white"  href="#">Student</a></li>
             <li><a class="dropdown-item text-white" href="#">HOD</a></li>
            <li><a class="dropdown-item text-white" href="#">Administrative</a></li>
          </ul>
        </div>
...
<!-- Modal -->
<div class="modal-dialog modal-dialog-centered" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
...
<!-- <div class="modal fade" id="signupModalToggle" aria-hidden="true" aria-labelledby="signupModalToggleLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="signupModalToggleLabel">Modal 1</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#signupModalToggle2" data-bs-toggle="modal">Open second modal</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="signupModalToggle2" aria-hidden="true" aria-labelledby="signupModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="signupModalToggleLabel2">Modal 2</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#signupModalToggle" data-bs-toggle="modal">Back to first</button>
      </div>
    </div>
  </div>
</div>
<button class="btn btn-primary" data-bs-target="#signupModalToggle" data-bs-toggle="modal">Open first modal</button>
 -->
